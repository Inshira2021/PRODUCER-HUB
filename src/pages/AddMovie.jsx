...
function AddMovie() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-black via-zinc-900 to-black relative">
      {/* Background Image */}
      <div 
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-6 sm:mb-8">
            <button
              ...
              className="flex items-center space-x-2 text-amber-200 hover:text-amber-100 mb-4 transition-colors"
            >
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-amber-50">
              {movieId ? 'Edit Movie' : 'Add New Movie'}
            </h1>
          </div>

          {/* Form Container */}
          <div className="bg-black/30 backdrop-blur-lg rounded-2xl p-6 sm:p-8 border border-amber-700/30 shadow-2xl">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div
                    ...
                    className="relative h-48 rounded-xl border-2 border-dashed border-amber-600/50 hover:border-amber-500 transition-colors cursor-pointer overflow-hidden bg-black/20 group"
                  >
                    {mainImagePreview ? (
                      <>
                      ...
                      <div className="flex flex-col items-center justify-center h-full">
                        ...
                        <p className="text-amber-300/70 text-sm">Click to upload main image</p>
                      </div>
                    )}
                  </div>
                  <input
              ...
              <div>
                <label htmlFor="trailerUrl" className="block text-sm font-medium text-amber-100 mb-2">
                  Trailer URL (Optional)
                </label>
                <input
                  id="trailerUrl"
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button
                  type="button"
                  onClick={handleClear}
                  className="flex-1 py-3 px-6 bg-transparent border-2 border-amber-700/50 hover:border-amber-600 hover:bg-amber-700/10 text-amber-200 font-semibold rounded-lg transition-all duration-300"
                >
                  Clear
                </button>
                <button
